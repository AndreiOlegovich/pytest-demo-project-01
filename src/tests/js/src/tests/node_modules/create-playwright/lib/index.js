...
async function createFiles(rootDir, files, force = false) {
  for (const [relativeFilePath, value] of files) {
    const absoluteFilePath = import_path.default.join(rootDir, relativeFilePath);
    if (import_fs.default.existsSync(absoluteFilePath) && !force) {
    ...
    console.log(import_ansi_colors.default.gray(`Writing ${import_path.default.relative(process.cwd(), absoluteFilePath)}.`));
    import_fs.default.mkdirSync(import_path.default.dirname(absoluteFilePath), { recursive: true });
    import_fs.default.writeFileSync(absoluteFilePath, value, "utf-8");
  }
}
function determinePackageManager(rootDir) {
  if (import_fs.default.existsSync(import_path.default.join(rootDir, "yarn.lock")))
    return "yarn";
...
// src/generator.ts
var assetsDir = import_path2.default.join(__dirname, "..", "assets");
var Generator = class {
  constructor(rootDir, options) {
    this.rootDir = rootDir;
    this.options = options;
    if (!import_fs2.default.existsSync(rootDir))
      import_fs2.default.mkdirSync(rootDir);
  ...
  _printPrologue() {
    ...
    console.log(`Initializing project in '${import_path2.default.relative(process.cwd(), this.rootDir) || "."}'`);
  }
  async _askQuestions() {
    var _a;
    ...
    if (this.options.quiet) {
      return {
        ...
        testDir: import_fs2.default.existsSync(import_path2.default.join(this.rootDir, "tests")) ? "e2e" : "tests",
        framework: void 0
      };
    }
    const isDefinitelyTS = import_fs2.default.existsSync(import_path2.default.join(this.rootDir, "tsconfig.json"));
    const questions = [
      !isDefinitelyTS && {
        type: "select",
        name: "language",
      ...
      !this.options.ct && {
        ...
        initial: import_fs2.default.existsSync(import_path2.default.join(this.rootDir, "tests")) ? "e2e" : "tests"
      },
      !this.options.ct && {
        type: "confirm",
  ...
  async _identifyChanges(answers) {
    ...
    if (installExamples)
      files.set(import_path2.default.join(answers.testDir, `example.spec.${fileExtension}`), this._readAsset(`example.spec.${fileExtension}`));
    if (!import_fs2.default.existsSync(import_path2.default.join(this.rootDir, "package.json"))) {
      commands.push({
    ...
    if (this.options.ct) {
      ...
      const htmlTemplate = executeTemplate(this._readAsset(import_path2.default.join("playwright", "index.html")), { extension }, /* @__PURE__ */ new Map());
      files.set("playwright/index.html", htmlTemplate);
      const jsTemplate = this._readAsset(import_path2.default.join("playwright", "index.js"));
  ...
  _patchGitIgnore() {
    const gitIgnorePath = import_path2.default.join(this.rootDir, ".gitignore");
    let gitIgnore = "";
    if (import_fs2.default.existsSync(gitIgnorePath))
      gitIgnore = import_fs2.default.readFileSync(gitIgnorePath, "utf-8").trimEnd() + "\n";
    if (!gitIgnore.includes("node_modules"))
      gitIgnore += "node_modules/\n";
    gitIgnore += "/test-results/\n";
    gitIgnore += "/playwright-report/\n";
    gitIgnore += "/playwright/.cache/\n";
    import_fs2.default.writeFileSync(gitIgnorePath, gitIgnore);
  }
  _readAsset(asset) {
    return import_fs2.default.readFileSync(import_path2.default.isAbsolute(asset) ? asset : import_path2.default.join(assetsDir, asset), "utf-8");
  }
  async _patchPackageJSON(answers) {
    var _a;
    const packageJSON = JSON.parse(import_fs2.default.readFileSync(import_path2.default.join(this.rootDir, "package.json"), "utf-8"));
  ...
  _printEpilogue(answers) {
    ...
    const pathToNavigate = import_path2.default.relative(process.cwd(), this.rootDir);
...
Inside that directory, you can run several commands:
  ...
  ${import_ansi_colors2.default.cyan(commandToRunTests(this.packageManager))}
    Runs the end-to-end tests.

  ${import_ansi_colors2.default.cyan(commandToRunTests(this.packageManager, "--project=chromium"))}
    Runs the tests only on Desktop Chrome.

  ${import_ansi_colors2.default.cyan(commandToRunTests(this.packageManager, exampleSpecPath))}
    Runs the tests in the specific file.

  ${import_ansi_colors2.default.cyan(`${commandToRunTests(this.packageManager, "--debug")}`)}
    Runs the tests in debug mode.

We suggest that you begin by typing:

  ${import_ansi_colors2.default.cyan(prefix + "  " + commandToRunTests(this.packageManager))}

And check out the following files:
  - .${import_path2.default.sep}${pathToNavigate ? import_path2.default.join(pathToNavigate, exampleSpecPath) : exampleSpecPath} - Example end-to-end test
  - .${import_path2.default.sep}${pathToNavigate ? import_path2.default.join(pathToNavigate, playwrightConfigPath) : playwrightConfigPath} - Playwright Test configuration

Visit https://playwright.dev/docs/intro for more information. \u2728

Happy hacking! \u{1F3AD}`);
  }
  _printEpilogueCT(answers) {
    console.log(import_ansi_colors2.default.green("\u2714 Success!") + " " + import_ansi_colors2.default.bold(`Created a Playwright Test project at ${this.rootDir}`));
    console.log(`
Inside that directory, you can run several commands:

  ${import_ansi_colors2.default.cyan(`${this.packageManager} run test-ct`)}
    Runs the component tests.

  ${import_ansi_colors2.default.cyan(`${this.packageManager} run test-ct -- --project=chromium`)}
    Runs the tests only on Desktop Chrome.

  ${import_ansi_colors2.default.cyan(`${this.packageManager} run test-ct App.test.ts`)}
    Runs the tests in the specific file.

  ${import_ansi_colors2.default.cyan(`${this.packageManager} run test-ct -- --debug`)}
    Runs the tests in debug mode.
...
function commandToRunTests(packageManager, args) {
...
(async () => {
  ...
  const rootDir = import_path3.default.resolve(process.cwd(), args[0] || "");
